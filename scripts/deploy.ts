...
async function main() {
  ...
  await addressOf("PushSplitter");
  await addressOf("ShakeableSplitter");
  await addressOf("SplitterFactory");

  await addressOf("PerpetualRoyalties");
  await addressOf("LimitedRoyalties");
  await addressOf("UntilRoyalties");
  await addressOf("RoyaltiesFactory");
